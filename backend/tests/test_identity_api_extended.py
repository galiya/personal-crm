"""Extended tests for identity resolution API endpoints.

Covers cases not already handled in test_identity_api.py:
...
- Matches with different confidence levels (high vs low score)
